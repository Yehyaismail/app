        ...
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500 dark:text-slate-400">إدارة المستخدمين والإحصائيات</p>
            </div>
          </div>
          ...
          <Button
            ...
            variant="outline"
            className="flex items-center gap-2 border-slate-200 dark:border-slate-600 hover:bg-slate-50 dark:hover:bg-slate-700 dark:text-slate-200"
        ...
        {stats && (
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8" data-testid="admin-stats">
            ...
            <div className="bg-white dark:bg-slate-800 rounded-xl p-5 border border-slate-200 dark:border-slate-700 shadow-sm">
              ...
              <p className="text-3xl font-semibold text-slate-900 dark:text-slate-100" data-testid="stat-total-users">
                {stats.total_users}
              </p>
            </div>
            ...
            <div className="bg-white dark:bg-slate-800 rounded-xl p-5 border border-slate-200 dark:border-slate-700 shadow-sm">
              <div className="flex items-center gap-3 mb-3">
                ...
                <span className="text-sm text-slate-500 dark:text-slate-400">المتصلون الآن</span>
              </div>
              <p className="text-3xl font-semibold text-slate-900 dark:text-slate-100" data-testid="stat-online-users">
                {stats.online_users}
              </p>
            </div>
            ...
            <div className="bg-white dark:bg-slate-800 rounded-xl p-5 border border-slate-200 dark:border-slate-700 shadow-sm">
              <div className="flex items-center gap-3 mb-3">
                ...
                <span className="text-sm text-slate-500 dark:text-slate-400">عدد الرسائل</span>
              </div>
              <p className="text-3xl font-semibold text-slate-900 dark:text-slate-100" data-testid="stat-total-messages">
            ...
            <div className="bg-white dark:bg-slate-800 rounded-xl p-5 border border-slate-200 dark:border-slate-700 shadow-sm">
              <div className="flex items-center gap-3 mb-3">
                ...
                <span className="text-sm text-slate-500 dark:text-slate-400">عدد الملفات</span>
              </div>
              <p className="text-3xl font-semibold text-slate-900 dark:text-slate-100" data-testid="stat-total-files">
                {stats.total_files}
              </p>
            </div>
            ...
            <table className="w-full">
              <thead>
                <tr className="bg-slate-50 dark:bg-slate-900/50 text-right">
                  <th className="px-5 py-3 text-xs font-medium text-slate-500 dark:text-slate-400 uppercase tracking-wider">الاسم</th>
                  ...
                  <th className="px-5 py-3 text-xs font-medium text-slate-500 dark:text-slate-400 uppercase tracking-wider">إجراءات</th>
                </tr>
              </thead>
                          ...
                          <AlertDialogContent className="dark:bg-slate-800 dark:border-slate-700">
                            <AlertDialogHeader>
                              ...
                              <AlertDialogDescription className="dark:text-slate-400">
                                ...
                                <strong className="dark:text-slate-200"> {u.name} </strong>؟
